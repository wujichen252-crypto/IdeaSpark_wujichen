          ...
          <div v-if="activeTab === 'notifications'" class="tab-pane">
            <div class="settings-list">
              <div class="setting-item">
                ...
                <label class="toggle">
                  <input v-model="settings.systemNotifications" type="checkbox" @change="saveSettings" />
              ...
              <div class="setting-item">
                ...
                <div class="item-content">
                  <div class="item-title">项目动态</div>
                  <div class="item-desc">当有人评论或点赞你的项目时通知</div>
                </div>
                <label class="toggle">
                  <input v-model="settings.projectNotifications" type="checkbox" @change="saveSettings" />
                  <span class="toggle-slider"></span>
                </label>
              </div>
              ...
              <div class="setting-item">
                ...
                <div class="item-content">
                  ...
                  <div class="item-desc">接收产品推荐和活动资讯</div>
                </div>
                <label class="toggle">
          ...
          <div v-if="activeTab === 'privacy'" class="tab-pane">
            <div class="settings-list">
              <div class="setting-item">
                ...
                <div class="item-content">
                  <div class="item-title">公开我的资料</div>
                  <div class="item-desc">允许其他用户查看你的个人主页</div>
                </div>
                <label class="toggle">
                  <input v-model="settings.publicProfile" type="checkbox" @change="saveSettings" />
                  <span class="toggle-slider"></span>
                </label>
              </div>
              ...
              <div class="setting-item">
                ...
                <div class="item-content">
                  <div class="item-title">显示在线状态</div>
